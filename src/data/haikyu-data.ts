...
export type SynergyDescriptions = Record<string, string | Record<string, string>>;

export type SynergyPairs = Record<string, string[][]>;
...
export const synergyDescriptions: SynergyDescriptions = {
  // paste ALL synergyDescriptions object here
};
...
export const synergyMeta: Record<string, SynergyMeta> = {
  // paste ALL synergyMeta object here
};
...
export const synergyPairs: SynergyPairs = {
  // paste ALL synergyPairs object here
};
